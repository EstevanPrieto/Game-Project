...
#Rooms in the game
#Rooms in the game
start = Room('Camp Center','Everything around you is in ruins. Nobody to be seen. Wonderful sight, eh? Oh yeah. To the north is an exit to a bridge. To the east is the laboratory. To the south is another exit to a bridge. Finally, to the west is the storage room. You should explore this settlement before going beyond.',
...
arm = Room('Armory', 'Ooh guns. Too bad they are all rusted. Is that a vault south of here??? WHAT\'S INSIDE???? North of here is the laboratory.', 'lab', None, 'final', None, None, None, None, None) 
...
w_peak = Room('West Peak', 'Oh, is that what we are looking for? It looks really odd to be a key. East of here is the peak.', None, 'peak', None, None, None, None, None, None)
one = Room('Area One', 
...
two_s = Room('Area Two - South', 'OK I AM TIRED OF YOUR-- wait. Is that something glistening in the ground? Well guess what, Deadbrain? You lucked out. Again. ', 'two', 'one_s', None, 'three_s', None, None, third_key, None)
...
'dining', None, 'e_tower', None, None, None, None, None)
...
boulder = Room('Boulder', 'That is a nice boulder.', 'hut', 'ruins', None, 'forest', None, None, None, None)
path = Room('Muddy Path', 'This path is leading us nowhere, dude. Please, listen to me for once. Let\'s go back.', 
...
None, None, None, 'trees', None, None, None, None,)
